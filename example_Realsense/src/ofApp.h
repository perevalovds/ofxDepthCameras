...
//
//This example shows how to use ofxDepthCameras addon for working with Realsense cameras.
//1. To compile successfully, set 64-bit cmpilation (because example contains 64-bit DLL's in its bin folder)
//2. Please check that you are using addon's "ofxDepthCameras_Realsense.cpp" file in the project, 
